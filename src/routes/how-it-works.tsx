...
export const Route = createFileRoute("/how-it-works")({
  ...
  head: () => ({
    meta: [
      { title: "How it works — TutorBook" },
      { name: "description", content: "See how TutorBook turns lesson dates into professional PDF invoices in under a minute — add students, log lessons, send invoices, track payments." },
      { property: "og:title", content: "How TutorBook works" },
...
const steps = [
  ...
  { icon: ClipboardList, title: "2. Log lessons", body: "Pick a student and tap the dates you taught. TutorBook fills in description, hours, and rate automatically." },
  { icon: Mic, title: "3. Or just dictate it", body: 'Tap the mic and say "Invoice Sarah for June 6, 13 and 20." TutorBook builds the invoice from your voice.' },
    ...
    <MarketingShell>
      <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-2xl">
          <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight">How TutorBook works</h1>
          <p className="text-muted-foreground mt-3">
            From your first student to your first paid invoice — here's exactly what using TutorBook looks like.
          </p>
        </div>
