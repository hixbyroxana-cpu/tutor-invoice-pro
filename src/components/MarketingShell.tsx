        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8 grid gap-6 sm:grid-cols-2 md:grid-cols-4 text-sm">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">LessonPaid</span>
            </div>
          ...
          <div className="text-xs text-muted-foreground">
            ...
            <a href="mailto:support@lessonpaid.app" className="hover:text-foreground">support@lessonpaid.app</a>
            <div className="mt-3">© {new Date().getFullYear()} LessonPaid.</div>
